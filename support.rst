...
In particolare, Faunalia garantisce servizi professionali per `QGIS <http://www.qgis.org/en/commercial-support.html>`_ (Desktop, Server e Web Client), GRASS_, PostgreSQL_ e `PostGIS <http://postgis.net/support/>`_:
