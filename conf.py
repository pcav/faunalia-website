# -*- coding: utf-8 -*-
#
# Faunalia documentation build configuration file, created by
# sphinx-quickstart on Fri Feb 10 09:29:43 2012.
#
...
#html_title = None
html_title = "Faunalia - free and open source GIS"

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = None
html_short_title = "Faunalia"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
#html_logo = None
html_logo = 'images/logo_faunalia.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
#html_favicon = None
html_favicon = 'images/favicon_faunalia.ico'
...
#html_sidebars = {}
html_sidebars = {'training': ['localtoc.html'], 'intro': ['localtoc.html'], 'jobs': ['localtoc.html'], 'animove': ['localtoc.html']} 
...
#latex_documents = [
#  ('corso_postgis', 'PostGIS.tex', u'PostGIS',
#    u'Paolo Cavallini - Faunalia', 'manual'),
#]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
#latex_logo = None
#latex_logo = '../logo_faunalia.png'
...
pdf_documents = [
        ('faunalia', u'Faunalia', u'Faunalia', u'Paolo Cavallini')
    ]
